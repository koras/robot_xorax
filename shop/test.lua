...
function getFailMarket(price, datetime)
    local checkRange = true;
    if setting.SPRED_LONG_TREND_DOWN_LAST_PRICE == 0 or setting.profit_range +
        setting.SPRED_LONG_TREND_DOWN_LAST_PRICE - setting.SPRED_LONG_TREND_DOWN >
        price - setting.profit_infelicity or
