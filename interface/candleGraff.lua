...
local function addSignal(arrGraff) 
 ...
 function updateLogSignalGraff(arrGraff)    
	...
	for keys = 1 , #arrGraff do
			...
			local txtdatetime = datetime.hour..':'..datetime.min..':'..datetime.sec    ;
...
function CreateNewTableGraff() 
	...
	AddColumn(t_graff, 5,  wordTitleTableLog.datetime, true,QTABLE_STRING_TYPE, 15);  
	AddColumn(t_graff, 6,  wordTitleTableLog.numberCandle, true,QTABLE_STRING_TYPE, 15);  
 ...
 function deleteTableGraff()   
	DestroyTable(t_graff)
 end;
